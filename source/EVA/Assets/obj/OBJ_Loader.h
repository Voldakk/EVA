	...
	private:
		...
		bool LoadMaterials(std::string path)
		{
			...
			while (std::getline(file, curline))
			{
                ...
                if (algorithm::firstToken(curline) == "norm") { tempMaterial.norm = algorithm::tail(curline); }
                if (algorithm::firstToken(curline) == "map_Pr") { tempMaterial.map_Pr = algorithm::tail(curline); }
                if (algorithm::firstToken(curline) == "map_Pm") { tempMaterial.map_Pm = algorithm::tail(curline); }
                if (algorithm::firstToken(curline) == "map_Ke") { tempMaterial.map_Ke = algorithm::tail(curline); }
			}
