...
namespace EVA
{
    class TextureManager
    {
      ...
      public:
        ...
        static Ref<Texture> CreateTexture(uint32_t width, uint32_t height, const void* data, TextureFormat format,
                                          const TextureSettings& settings = DefaultTextureSettings);
