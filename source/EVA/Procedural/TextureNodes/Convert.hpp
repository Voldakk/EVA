    ...
    namespace TextureNodes
    {
        class EdgeDetect : public ComputeNode
        {
          ...
          public:
            EdgeDetect()
            {
                SetShader("convert/edge_detect.glsl");
                SetTexture(TextureR);
            }
        ...
        class HeightToAmbientOcclusion : public ComputeNode
        {
          ...
          public:
            ...
            {
                SetShader("convert/height_to_ao.glsl");
                SetTexture(TextureR);
            }
        ...
        class HeightToCurvature : public ComputeNode
        {
          ...
          public:
            HeightToCurvature()
            {
                SetShader("convert/height_to_curvature.glsl");
                SetTexture(TextureR);
            }
        ...
        class HeightToNormal : public ComputeNode
        {
          ...
          public:
            HeightToNormal()
            {
                SetShader("convert/height_to_normal.glsl");
